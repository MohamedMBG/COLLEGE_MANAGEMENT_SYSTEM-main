...
public:
    Cours();
    Cours(string CName, int CNum, int t, string niveau , vector<Personnel> teachers);
    ~Cours();
    // getters and setters
...
{
private:
    vector<Etudiant> eleveIng;
    vector<Cours> Modules;
    vector<double> grades;

public:
    Notes();
    ~Notes();
    void addGrade(int ce, int cc, double grade, vector<Etudiant> students, vector<Cours> courses);
    double fetchGrade(int ce);
...
public:
    Abscence();
    ~Abscence();
    void addAbscence(int codestd , int codeCours , string date , vector<Etudiant> students , vector<Cours> courses);
